...
Route::put('/user/{id}/follow', [App\Http\Controllers\UserController::class, 'follow']);
//Route::put('/user/{id}/followers', [App\Http\Controllers\UserController::class, 'followers']);
//Route::put('/user/{id}/photos', [App\Http\Controllers\UserController::class, 'photos']);
